  ...
  if (!course) {
    return (
      <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: "2rem", background: "#f7f5fe" }}>
        <div style={{ maxWidth: "40rem", width: "100%", borderRadius: "1.25rem", padding: "2rem", background: "#fff", boxShadow: "0 1rem 2.625rem rgba(22,10,46,0.08)" }}>
  ...
  return (
    <main style={{ minHeight: "100vh", padding: "3.5rem 1.25rem", background: "linear-gradient(160deg,#f7f5fe 0%,#f2ecff 50%,#fdf7ff 100%)" }}>
      <div style={{ maxWidth: 920, margin: "0 auto" }}>
        ...
        <section style={{ borderRadius: "1.5rem", padding: "2rem", background: "rgba(255,255,255,0.86)", border: "1px solid rgba(255,255,255,0.95)", backdropFilter: "blur(12px)", boxShadow: "0 1.25rem 3rem rgba(22,10,46,0.10)" }}>
          ...
          {course.highlightTitle && (
            <div style={{ marginTop: "1rem", padding: "0.95rem 1rem", borderRadius: "0.875rem", background: "linear-gradient(120deg,#fff4cb,#ffe8a5)", border: "1px solid #f0cf68", boxShadow: "0 0.625rem 1.375rem rgba(240,192,64,0.2)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.8rem", marginTop: "1rem", flexWrap: "wrap" }}>
            <button
              ...
              style={{
                ...
                boxShadow: "0 0.5rem 1.5rem rgba(107,53,200,0.35)",
              }}
            >
              Enroll Now
            </button>
...
function MetaCard({ label, value }) {
  return (
    <div style={{ borderRadius: "0.75rem", padding: "0.85rem 0.95rem", background: "#fff", border: "1px solid #ece4ff" }}>
