      ...
      <div className="relative z-10">
        ...
        <main>
          ...
          <section className="px-6 pb-20">
            <div className="mx-auto max-w-[1160px]">
              <div className="mb-10">
                ...
                <div className="mb-3 h-0.5 w-9 rounded-full bg-gradient-to-r from-[var(--color-p-500)] to-[var(--color-rose)]" />
                <h2 className="font-display text-[clamp(2rem,_3.5vw,_3rem)] font-bold leading-tight text-[var(--color-ink)]">Published <em className="not-italic text-[var(--color-p-600)]">Works</em></h2>
              </div>
              <div className="relative overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.14)] p-8" style={{background:"linear-gradient(145deg,var(--color-p-900) 0%,#20084a 50%,var(--color-p-900) 100%)",boxShadow:"0 14px 42px rgba(24,10,48,0.35)"}}>
                ...
                <div className="relative z-10 grid gap-8 md:grid-cols-2">
                  {books.map((book) => (
                    <div key={book.title} className="rounded-xl p-6 transition-all hover:bg-[rgba(255,255,255,0.05)]">
                      <div className="mb-4 flex h-40 items-center justify-center rounded-xl bg-gradient-to-br from-[rgba(240,192,64,0.2)] to-[rgba(139,92,246,0.2)]">
                        <span className="font-display px-4 text-center text-lg font-bold leading-tight text-white/80">{book.title}</span>
                      </div>
                      ...
                      <Link href="/publications/books" className="mt-4 inline-flex items-center gap-1 text-xs font-bold uppercase tracking-wider text-[var(--color-p-300)] transition-all hover:translate-x-1">Learn More →</Link>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <section className="px-6 pb-28">
            <div className="mx-auto max-w-[1160px]">
              <div className="mb-10">
                <span className="mb-2 block text-xs font-semibold uppercase tracking-[0.3em] text-[var(--color-p-600)]">Articles &amp; Blog</span>
                <div className="mb-3 h-0.5 w-9 rounded-full bg-gradient-to-r from-[var(--color-p-500)] to-[var(--color-rose)]" />
                <h2 className="font-display text-[clamp(2rem,_3.5vw,_3rem)] font-bold leading-tight text-[var(--color-ink)]">Latest <em className="not-italic text-[var(--color-p-600)]">Insights</em></h2>
              </div>
              <p className="text-sm leading-relaxed text-[var(--color-muted)]">Articles and blog posts coming soon. Stay connected for insights on the 4R Framework, Zero Philosophy, and the Peaceful Profit Monk journey.</p>
              <Link href="/publications/blog" className="btn-secondary mt-6 inline-block">Visit Blog</Link>
            </div>
          </section>
        </main>
        <Footer />
